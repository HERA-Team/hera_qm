...
def test_xrfi_run(tmpdir):
    ...
    ext_labels = {'ag_flags1': 'Abscal gains, median filter. Flags.',
                  ...
                  'omnical_chi_sq_flags1': 'Omnical overall z-score, median filter. Flags.',
                  'omnical_chi_sq_flags2': 'Omnical overall z-score, median filter, round 2. Flags.',
                  'omnical_chi_sq_renormed_metrics1': 'Omnical overall z-score, median filter.',
                  'omnical_chi_sq_renormed_metrics2': 'Omnical overall z-score, median filter, round 2.',
                  'abscal_chi_sq_flags1': 'Abscal overall z-score, median filter. Flags.',
                  'abscal_chi_sq_flags2': 'Abscal overall z-score, median filter, round 2. Flags.',
                  'abscal_chi_sq_renormed_metrics1': 'Abscal overall z-score, median filter.',
                  'abscal_chi_sq_renormed_metrics2': 'Abscal overall z-score, median filter, round 2.',
